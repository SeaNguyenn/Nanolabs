            ...
            <DialogPanel
              ...
              <a-form :model="form" enctype="multipart/form-data" @submit="onSubmit">
                <div class="flex flex-wrap gap-4 bg-white px-4 pt-5 pb-4">
                  <Input v-model="form.name" size="sm" placeholder="" type="text" required label="Tên" class="w-40" />
                  <Input v-model="form.email" size="sm" placeholder="" type="email" required label="Email" class="w-40" />
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <a-form :model="form" enctype="multipart/form-data" @submit="onSubmitEdit">
                <div class="flex flex-wrap gap-4 bg-white px-4 pt-5 pb-4">
                  <Input v-model="form.name" size="sm" placeholder="" type="text" required label="Tên" class="w-40" />
                  <Input v-model="form.email" size="sm" placeholder="" type="email" required label="Email" class="w-40" />
                  <Input v-model="form.phone" size="sm" placeholder="" type="number" required label="Số đt"
