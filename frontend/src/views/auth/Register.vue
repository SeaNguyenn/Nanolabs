<template>
  <div class="flex justify-between items-center">
    ...
    <router-link :to="{ name: 'login' }" class="group relative flex items-center justify-center rounded-md py-3.5 px-3 font-semibold bg-blue-500 text-white hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:bg-blue-500">
  ...
  <div class="flex justify-center content-center mt-10">
    <div class="w-full max-w-md space-y-8">
      <div class="rounded-md border p-5 bg-white shadow-sm">
        ...
        <form class="mt-9 space-y-6" id="form" @submit="onSubmit">
